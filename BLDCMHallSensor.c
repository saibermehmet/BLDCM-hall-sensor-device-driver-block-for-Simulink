 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Oct 20 12:56:18 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                BLDCMHallSensor
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 CPRValueResetRequest_b8
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 InitialCPRValue_s32
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 TransitionErrorReset_b8
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 CPRResetValue_s32
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                TransitionCPRValue_s32
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                TransitionErrorFlag_b8
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                TransitionErrorCounter_u32
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                BLDCMDirection_s8
...
extern void BLDCMHallSensor_Outputs_wrapper(const boolean_T
  *CPRValueResetRequest_b8,
  ...
  SimStruct *S);
extern void BLDCMHallSensor_Update_wrapper(const boolean_T
  *CPRValueResetRequest_b8,
  const int32_T *InitialCPRValue_s32,
  const boolean_T *TransitionErrorReset_b8,
  const int32_T *CPRResetValue_s32,
...
{
  const boolean_T *CPRValueResetRequest_b8 = (boolean_T *)
    ssGetInputPortRealSignal(S, 0);
  const int32_T *InitialCPRValue_s32 = (int32_T *) ssGetInputPortRealSignal(S, 1);
  const boolean_T *TransitionErrorReset_b8 = (boolean_T *)
    ssGetInputPortRealSignal(S, 2);
  const int32_T *CPRResetValue_s32 = (int32_T *) ssGetInputPortRealSignal(S, 3);
  int32_T *TransitionCPRValue_s32 = (int32_T *) ssGetOutputPortRealSignal(S, 0);
  boolean_T *TransitionErrorFlag_b8 = (boolean_T *) ssGetOutputPortRealSignal(S,
    1);
  uint32_T *TransitionErrorCounter_u32 = (uint32_T *) ssGetOutputPortRealSignal
    (S, 2);
  int8_T *BLDCMDirection_s8 = (int8_T *) ssGetOutputPortRealSignal(S, 3);
  const real_T *xD = ssGetDiscStates(S);
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const int_T p_width1 = mxGetNumberOfElements(PARAM_DEF1(S));
  const int_T p_width2 = mxGetNumberOfElements(PARAM_DEF2(S));
  const real_T *PinA_u8 = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *PinB_u8 = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *PinC_u8 = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  BLDCMHallSensor_Outputs_wrapper(CPRValueResetRequest_b8, InitialCPRValue_s32,
    TransitionErrorReset_b8, CPRResetValue_s32, TransitionCPRValue_s32,
    TransitionErrorFlag_b8, TransitionErrorCounter_u32, BLDCMDirection_s8, xD,
    PinA_u8, p_width0, PinB_u8, p_width1, PinC_u8, p_width2, S);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const real_T *PinB_u8 = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *PinC_u8 = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  BLDCMHallSensor_Update_wrapper(CPRValueResetRequest_b8, InitialCPRValue_s32,
    TransitionErrorReset_b8, CPRResetValue_s32, TransitionCPRValue_s32,
    TransitionErrorFlag_b8, TransitionErrorCounter_u32, BLDCMDirection_s8, xD,
    PinA_u8, p_width0, PinB_u8, p_width1, PinC_u8, p_width2, S);
}
